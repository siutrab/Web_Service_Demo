...
void IdColumn::setValue(void* value)		{ this->value = *(static_cast<unsigned int*>(value)); }
...
void NameColumn::setValue(void* value)		{ this->value = *(static_cast<std::string*>(value)); }
